# Chính sách Bảo mật cho ứng dụng "Ru"

**Ngày cập nhật cuối cùng:** 04/08/2026

Ứng dụng "Ru" (sau đây gọi là "Ứng dụng") được cung cấp bởi chúng tôi với cam kết bảo vệ quyền riêng tư của người dùng. Chính sách này giải thích cách chúng tôi thu thập, sử dụng và bảo mật thông tin của bạn khi bạn sử dụng Ứng dụng.
...
## 2. Sử dụng Quyền Truy cập

Ứng dụng yêu cầu một số quyền cơ bản để hoạt động đúng chức năng:

*   **Dịch vụ chạy nền (Foreground Service):** Để duy trì âm thanh khi bạn tắt màn hình hoặc chuyển sang ứng dụng khác.
*   **Wake Lock:** Ngăn thiết bị ngắt âm thanh đột ngột khi đi vào chế độ ngủ (Doze mode).
*   **Thông báo:** Để hiển thị bảng điều khiển âm thanh trên thanh thông báo.

**Chúng tôi cam kết KHÔNG yêu cầu các quyền nhạy cảm như:** Micro, Vị trí, Danh bạ hay Máy ảnh.

## 3. Chia sẻ Dữ liệu với Bên Thứ ba

Chúng tôi không bán hay chia sẻ thông tin cá nhân của bạn cho bất kỳ bên thứ ba nào vì mục đích thương mại. Chúng tôi chỉ sử dụng các dịch vụ tin cậy từ Google (Firebase) để vận hành ứng dụng:
